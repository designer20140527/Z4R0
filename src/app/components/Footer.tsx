        ...
        <div className="mb-12 h-[60px] flex items-center overflow-visible">
          <Dock iconSize={40} iconMagnification={60} iconDistance={100} className="h-[60px]">
            ...
            <DockIcon className="bg-[#101935] rounded-xl hover:bg-[#172043] transition-colors">
              <Link href="https://twitter.com/z4r0_protocol" target="_blank" className="flex items-center justify-center w-full h-full">
            ...
            {/* Telegram Icon */}
            <DockIcon className="bg-[#101935] rounded-xl hover:bg-[#172043] transition-colors">
              <Link href="https://t.me/z4r0_protocol" target="_blank" className="flex items-center justify-center w-full h-full">
